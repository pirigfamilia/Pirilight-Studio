  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Semantic status tones (shared by the future WorkStatusBadge/AttentionList).
        success: {
        ...
        // "Chrome" fixo da app (Sidebar/Topbar) — não muda com o tema.
        chrome: {
          DEFAULT: "hsl(var(--chrome-background))",
